export const up = async (queryInterface, Sequelize) => {
  ...
  if (hasApiClientsLegacy) {
    if (!hasApiClient) {
      ...
      await queryInterface.sequelize.query(
        `INSERT INTO "ApiClient" (id, name, password, work_email, api_key, role, permissions, active)
         SELECT id, name, password, work_email, api_key, (role::text)::"enum_ApiClient_role" AS role, permissions, active
         FROM "Api-Clients" l
